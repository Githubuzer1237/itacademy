...
const Squares2 = ({
  ...
  >
    <h1 className="h1__titlee">print ("Курсы по Python")</h1>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    <p  className='python__p'    >Освойте универсальный язык программирования для веба, автоматизации, анализа данных и создания ИИ!</p>
    <b className='python_b'>{price} </b>
      <Link onClick={scrollToConnectSection} className="curslink"> → Курс мечты</Link>
    </div>
